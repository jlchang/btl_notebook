...
cp -i /cil/shed/apps/internal/wdl/smartseq_miseq.wdl $dirPath/SSF-$1/
...
echo "use Python-2.7"
echo "/cil/shed/apps/internal/widdler/widdler.py run $dirPath/SSF-$1/smartseq_miseq.wdl $dirPath/SSF-$1/input_$2.json -D -o workflow_failure_mode:NoNewCalls -S btl-cromwell"
echo
