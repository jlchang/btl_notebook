...
echo -e "  \x22smrtseq.input_samples_files\x22: \x22/gsap/assembly_analysis/SSF/SmartSeq2/SSF-$1/input_data.tsv\x22,"
echo -e "  \x22smrtseq.output_dir\x22: \x22/gsap/assembly_analysis/SSF/SmartSeq2/SSF-$1/SSF-$1_SmartSeqAnalysisV1.1_$2\x22,"
