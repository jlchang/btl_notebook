...
#  fi
  ...
  cd ${sample}_PE 
  mv ${sample}.mapq1.PE.nodup.brokenqc ${sample}.mapq1.PE.nodup.broken.qc
  mv ${sample}.mapq1.PE.nodup.brokenpdf ${sample}.mapq1.PE.nodup.broken.pdf
  mv ${sample}.brokenmetrics ${sample}.broken.metrics
  mv ${sample}.metrics ${sample}.brokentest.metrics
