...
#  fi
  ...
  cd ${sample}_PE 
  mv ${sample}.mapq1.PE.nodup.bedpe.gz ${sample}.mapq1.PE2SE.nodup.bedpe.gz
  mv ${sample}.mapq1.PE.nodup.tagAlign.gz ${sample}.mapq1.PE2SE.nodup.tagAlign.gz
  mv ${sample}.mapq1.PE.nodup.15M.tagAlign.gz ${sample}.mapq1.PE2SE.nodup.15M.tagAlign.gz
  mv ${sample}.mapq1.PE.nodup.15M.tagAlign.qc ${sample}.mapq1.PE2SE.nodup.15M.tagAlign.qc
  mv ${sample}.mapq1.PE.nodup.15M.tagAlign.pdf ${sample}.mapq1.PE2SE.nodup.15M.tagAlign.pdf
