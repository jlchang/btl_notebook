...
# BWA genome index
BWA_INDEX_NAME="/seq/references/Rattus_norvegicus/v0/Rattus_norvegicus.fasta"
# threads
NTHREADS="1"
...
Rscript $SCRIPTDIR/run_spp.R -c=${PAIRED_MAPQ_FILE} -filtchr=chrM -savp -out=${PAIRED_MAPQ_PREFIX}.qc
